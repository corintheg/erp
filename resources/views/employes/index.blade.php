    ...
    <main class="main-content flex-1 ml-0 md:ml-64 p-6 text-sm">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="mb-4 flex flex-col sm:flex-row gap-4">
                ...
                <!-- Filtre Actif -->
                <select id="activeFilter" class="w-full sm:w-1/4 px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#38d62c]">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    ...
                    @forelse ($employes as $employe)
                        <tr class="border-b hover:bg-gray-50 employee-item"
                            data-nom="{{ strtolower($employe->nom) }}"
                            data-prenom="{{ strtolower($employe->prenom) }}"
