    ...
    <div class="flex min-h-screen">
        ...
        <div class="fixed inset-y-0 left-0 w-64 bg-gray-800 text-white shadow-lg">
            <div class="p-6">
                ...
                <nav class="space-y-4">
                    <a href="#" class="block px-4 py-2 rounded-md hover:bg-gray-700 transition duration-200">Tableau de
                        bord</a>
                    <a href="#"
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="mt-4">
                        @csrf
                        <button type="submit"
                            class="w-full text-left px-4 py-2 rounded-md hover:bg-gray-700 transition duration-200">
                            Déconnexion
                        </button>
                    </form>
                </nav>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left">
                            ...
                            <tbody id="leaveRequests">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center py-4 text-gray-500">Aucune demande de congé
                                            trouvée.</td>
                                    </tr>
                                @endforelse
                            </tbody>
