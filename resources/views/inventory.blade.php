...
<aside id="sidebar" class="sidebar w-64 bg-gray-800 text-[#55deaf] h-full fixed">
    ...
    <div id="search-bar-sidebar" class="p-4">
        <div class="relative">
            <input type="text" id="search-sidebar" placeholder="Rechercher un mouvement..." class="w-full bg-gray-700 text-white border rounded-lg py-2 px-4 focus:outline-none focus:ring-2 focus:ring-[#55deaf]">
    ...
    <header class="bg-white shadow p-4 rounded-lg mb-6 flex justify-between items-center">
        ...
        <div class="flex items-center space-x-4">
            <div id="search-bar-header" class="relative">
                <input type="text" id="search-header" placeholder="Rechercher un mouvement..." class="border rounded-lg py-2 px-4 focus:outline-none focus:ring-2 focus:ring-blue-500">
